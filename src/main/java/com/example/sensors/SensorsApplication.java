...
public class SensorsApplication {
	/**
	 * On startup:<br>
	 *  - Init the central units that are saved in the db and inject the sensors.<br>
	 ...
	 * After the initialization, we are able to use the spring boot rest pattern to fetch/update data
	 * for the client.
	 */
